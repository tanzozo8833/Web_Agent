...
**App Name**: Sidebar App
**Purpose**: Demonstrates a vertical sidebar navigation component for web applications
**Use Case**: When you need a vertical navigation menu on the left side of the page
